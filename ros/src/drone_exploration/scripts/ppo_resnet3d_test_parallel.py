...
def parse_args():
    ...
    parser.add_argument("--savedmodelpath", type=str, default="/media/mrmmm/Data/model/ppo_resnet3d/",
        help="the id of the environment")
    parser.add_argument("--checkpointpath", type=str, default="/media/mrmmm/Data/model/ppo_resnet3d/best.pth",
        help="the id of the environment")
